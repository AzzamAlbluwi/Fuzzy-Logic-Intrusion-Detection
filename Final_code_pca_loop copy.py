...
best_tpp = best_true_positives / (best_true_positives + best_false_negatives) * 100

# Calculate false positive percentage for the best configuration
best_fpp = best_false_positives / (best_false_positives + best_true_negatives) * 100

# Calculate true negative percentage for the best configuration
best_tnp = best_true_negatives / (best_true_negatives + best_false_positives) * 100

# Calculate false negative percentage for the best configuration
best_fnp = best_false_negatives / (best_false_negatives + best_true_positives) * 100
